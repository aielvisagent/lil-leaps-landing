...
export default function BlogCTA() {
  return (
    <div className="mt-16 pt-12 border-t border-mint-light">
      <div className="bg-mint-pale rounded-[20px] p-8 md:p-10 text-center">
        <p className="font-quicksand text-xs font-bold text-coral uppercase tracking-widest mb-3">
          Start capturing memories
        </p>
        <h3 className="font-nunito text-2xl md:text-3xl font-black text-navy mb-3">
          Try lil leaps free for 1 month
        </h3>
        <p className="text-text-light text-base max-w-[440px] mx-auto mb-6 leading-relaxed">
          5 seconds a week. That&apos;s all it takes to build a growth timelapse
