    ...
    <section className="min-h-screen flex items-center px-6 pt-24 pb-16 md:px-8 relative overflow-hidden bg-mint-pale">
      ...
      <div className="max-w-[1100px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center relative z-10">
        ...
        <div className="animate-fade-in-up-3 flex justify-center order-first md:order-last">
          <div className="animate-float-phone w-[220px] h-[448px] md:w-[280px] md:h-[570px] bg-navy rounded-[44px] p-2.5 shadow-[0_30px_80px_rgba(45,59,78,0.2),0_8px_24px_rgba(45,59,78,0.1),inset_0_0_0_2px_rgba(255,255,255,0.08)]">
            <div className="w-full h-full rounded-[36px] overflow-hidden relative">
              <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[110px] h-[26px] bg-navy rounded-b-[18px] z-10" />
              <Image
