...
export default function Hero() {
  return (
    <section className="min-h-screen flex items-center justify-center px-6 pt-24 pb-16 md:px-8 relative overflow-hidden bg-mint-pale">
      ...
      <div className="max-w-[600px] mx-auto text-center relative z-10">
        ...
        <p className="animate-fade-in-up-2 text-lg text-text-light leading-relaxed mb-8 max-w-[540px] mx-auto">
        ...
        <div className="animate-fade-in-up-3 flex gap-3 flex-wrap justify-center" id="download">
