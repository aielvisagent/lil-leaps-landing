      ...
      <div className="max-w-[1100px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center relative z-10">
        <div className="max-w-[500px] mx-auto md:mx-0 text-center md:text-left">
          ...
          <div className="animate-fade-in-up-3 flex gap-3 flex-wrap justify-center md:justify-start" id="download">
            <a href="https://apps.apple.com/us/app/lil-leaps/id6746146083" className="bg-coral text-white px-7 py-3.5 rounded-[14px] font-extrabold text-base inline-flex items-center gap-2 hover:bg-coral-dark hover:-translate-y-0.5 transition-all shadow-[0_4px_15px_rgba(242,112,109,0.25)] hover:shadow-[0_8px_25px_rgba(242,112,109,0.25)]">
              <AppleIcon />
              Download for iOS
            </a>
